  ...
  return (
    <>
      ...
      <div className='mx-10 sm:mx-15 md:mx-25 lg:mx-30 p-8'>
        <h1 className='text-5xl font-extrabold py-10 lg:px-20'>Nossos produtos</h1>
      ...
      {/*Sobre nos*/}
      <div className='my-10 mx-10 sm:mx-15 md:mx-25 lg:mx-30 p-10 rounded-4xl bg-amber-300 '>
        <h1 className='text-5xl font-extrabold py-10 lg:px-20'>Nossa história</h1>

        <div className='lg:flex items-center p-10'>
          <img className='w-100 ml-20 object-contain' src={imgPlaceholder} />
          <div className='py-10 px-30 text-xl flex-grow'>
            <p className='text-2xl font-bold'>Duas irmãs gêmeas, pernambucanas, com os nomes "maria" e "melo" iguais... </p> 
            <p className='text-xl text-justify'> <br />...e também iguais na cara, gosto, cabelo, roupa e o amor por artesanato. Nem sempre foi tecido, começamos em 2002 com pintura em madeira. Desenvolvemos um estilo próprio com cores vibrantes e e contorno aquarelado. Buscando inovar, em 2007 introduzimos o tecido em nossas peças, e é nosso foco desde de 2012. Até agora, foram 16 participações na Fenearte, a maior feira de artesanato da América Latina!</p>
          </div>
        </div>
