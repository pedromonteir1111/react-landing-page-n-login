    ...
    return (
        <>
            <div className="mx-10 sm:mx-15 md:mx-25 lg:mx-30 p-8">
                <h1 id="contato" className='text-5xl font-extrabold py-10 lg:px-20 scroll-mt-25'>Entre em contato</h1>
                <div className='flex flex-col lg:flex-row items-center px-10'>  
                    <div className='lg:px-30 text-xl flex-grow'>
                        <p className='text-2xl font-bold text-center lg:text-left'>Levamos nosso artesanato até você! </p> 
